...
find_medcodes <- function(medcodes,lm_time=0){
  ...
  if(lm_time==0){
    ...
    a <- tryCatch(
      {
        res <- clinical_before_nolink[clinical_before_nolink$medcode[] %in% medcodes$medcode,c('patid','eventdate','medcode')]
    ...
    a <- tryCatch(
      {
        res <- referral_before_nolink[referral_before_nolink$medcode[] %in% medcodes$medcode,c('patid','eventdate','medcode')]
        relevant <- ffdfappend(relevant,res)
      }, warning = function(w) {}, error = function(e) {}, finally = {}
    )
    ...
    a <- tryCatch(
      {
        res <- test_before_nolink[test_before_nolink$medcode[] %in% medcodes$medcode,c('patid','eventdate','medcode')]
        relevant <- ffdfappend(relevant,res)
      }, warning = function(w) {}, error = function(e) {}, finally = {}
    )
    ...
    a <- tryCatch(
      {
        res <- immunisation_before_nolink[immunisation_before_nolink$medcode[] %in% medcodes$medcode,c('patid','eventdate','medcode')]
        relevant <- ffdfappend(relevant,res)
      }, warning = function(w) {}, error = function(e) {}, finally = {}
    )
    ...
    if(lm_time==2012){
      ...
      a <- tryCatch(
        {
          res <- clinical2012_before_nolink[clinical2012_before_nolink$medcode %in% medcodes$medcode,c('patid','eventdate','medcode')]
          relevant <- ffdfappend(relevant,res)
        }, warning = function(w) {}, error = function(e) {}, finally = {}
      )
      ...
      a <- tryCatch(
        {
          res <- referral2012_before_nolink[referral2012_before_nolink$medcode %in% medcodes$medcode,c('patid','eventdate','medcode')]
          relevant <- ffdfappend(relevant,res)
        }, warning = function(w) {}, error = function(e) {}, finally = {}
      )
      ...
      a <- tryCatch(
        {
          res <- test2012_before_nolink[test2012_before_nolink$medcode %in% medcodes$medcode,c('patid','eventdate','medcode')]
          relevant <- ffdfappend(relevant,res)
        }, warning = function(w) {}, error = function(e) {}, finally = {}
      )
      ...
      a <- tryCatch(
        {
          res <- immunisation2012_before_nolink[immunisation2012_before_nolink$medcode %in% medcodes$medcode,c('patid','eventdate','medcode')]
          relevant <- ffdfappend(relevant,res)
        }, warning = function(w) {}, error = function(e) {}, finally = {}
      )
